    ...
    "models/cube", "models/parametric"],
        (function(glmatrix, Program, SceneNode, shaders, DirectionalLight, Material, texture,
            ...
            var Scene = function(gl) {
                ...
                this.programs.vertex_color = new Program(gl, shaders.getVertexShader("vertex_color"),
                ...
                // GridPlanet 
                this.gridPlanet = new ParametricSurface(gl, positionFunc, {asWireframe: true});
                this.gridNode = new SceneNode("Grid");
                this.gridNode.add(this.gridPlanet, this.materials.grid);

                // planet surface
                this.planetSurface = new ParametricSurface(gl, positionFunc, {filled: true});
                ...
                // rotate the poles in the right angle
                mat4.rotate(this.planetNode.transform(), Math.PI / 2.0, [1, 0, 0]);
